    ...
    companion object {
        private val COLLECTION_IDS = listOf(
            EnrichmentCollectionId(
                ...
                collectionId = "0x82c7a8f707110f5fbb16184a5933e9f78a34c6ab"
            ),
            EnrichmentCollectionId(
                blockchain = BlockchainDto.ETHEREUM,
            ...
            EnrichmentCollectionId(
                blockchain = BlockchainDto.ETHEREUM,
                collectionId = "0xb66a603f4cfe17e3d27b87a8bfcad319856518b8"
            ),
            EnrichmentCollectionId(
                blockchain = BlockchainDto.ETHEREUM,
                collectionId = "0xc9154424b823b10579895ccbe442d41b9abd96ed"
            ),
            EnrichmentCollectionId(
                blockchain = BlockchainDto.POLYGON,
                collectionId = "0x35f8aee672cde8e5fd09c93d2bfe4ff5a9cf0756"
            ),
            EnrichmentCollectionId(
                blockchain = BlockchainDto.POLYGON,
                collectionId = "0xa2d9ded6115b7b7208459450d676f0127418ae7a"
            ),
            EnrichmentCollectionId(
                blockchain = BlockchainDto.POLYGON,
                collectionId = "0x2953399124f0cbb46d2cbacd8a89cf0599974963"
            ),
            EnrichmentCollectionId(
                blockchain = BlockchainDto.POLYGON,
                collectionId = "0x03e055692e77e56abf7f5570d9c64c194ba15616"
            ),
            EnrichmentCollectionId(
                blockchain = BlockchainDto.IMMUTABLEX,
                collectionId = "0x184612188346bf155f40861c3e72ae54e87358e6"
            ),
        )
    }
}
