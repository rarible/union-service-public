...
class SearchReindexerConfiguration(
    ...
    @Bean
    fun activityTask(activityClient: ActivityControllerApi, taskRepository: TaskRepository): TaskHandler<String> {
        return ActivityTask(this, activityClient, taskRepository)
    }
