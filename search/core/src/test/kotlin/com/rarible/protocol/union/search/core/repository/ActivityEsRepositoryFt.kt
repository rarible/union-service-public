...
import com.rarible.protocol.union.search.test.AbstractIntegrationTest
...
internal class ActivityEsRepositoryFt {
    ...
    @Test
    fun `should init`(): Unit = runBlocking {
        val activity = ElasticActivity(
            "1234", Instant.MIN, 1, 0, BlockchainDto.ETHEREUM, ActivityTypeDto.BURN,
        ...
        val id = activityEsRepository.putDocument(activity)
        val found = activityEsRepository.getById(id)
