...
class CurrencyServiceTest {
    ...
    fun `should cache consequent calls of getAllCurrencyRates`() = runBlocking<Unit> {
        ...
        coVerify(exactly = 1) {
            currencyControllerApi.allCurrencies
            currencyControllerApi.getCurrencyRate("ETHEREUM", "0x0000000000000000000000000000000000000000", any())
            currencyControllerApi.getCurrencyRate("FLOW", "A.1654653399040a61.FlowToken", any())
            currencyControllerApi.getCurrencyRate("POLYGON", "0x0000000000000000000000000000000000000000", any())
            currencyControllerApi.getCurrencyRate("TEZOS", "tz1Ke2h7sDdakHJQh8WX4Z372du1KChsksyU", any())
            currencyControllerApi.getCurrencyRate("SOLANA", "So11111111111111111111111111111111111111112", any())
            currencyControllerApi.getCurrencyRate("IMMUTABLEX", "0x0000000000000000000000000000000000000000", any())
            currencyControllerApi.getCurrencyRate("MANTLE", "0x0000000000000000000000000000000000000000", any())
        }
