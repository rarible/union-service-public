...
class ImxItemServiceTest {
    ...
    private val expectedAsset by lazy {
        mapper.readValue(
            ImxItemServiceTest::class.java.getResourceAsStream("asset.json"),
    ...
    private val expectedMint by lazy {
        mapper.readValue(
            ImxItemServiceTest::class.java.getResourceAsStream("mint.json"),
            ImmutablexMint::class.java
        )

    }

    val assetClient = mockk<ImxAssetClient> {
        coEvery { getById(any()) } returns expectedAsset
    }

    val activityClient = mockk<ImxActivityClient> {
    ...
    private val service = ImxItemService(assetClient, activityClient)
