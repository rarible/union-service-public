...
abstract class EthActivityEventHandler(
...
) : AbstractBlockchainEventHandler<com.rarible.protocol.dto.ActivityDto, ActivityDto>(
    blockchain,
    EventType.ACTIVITY
) {
    ...
    override suspend fun convert(event: com.rarible.protocol.dto.ActivityDto): ActivityDto {
