...
import com.rarible.protocol.union.integration.ethereum.data.randomEthLooksRareOrderV2Dto
...
class EthOrderConverterTest {
    ...
    @Test
    fun `eth order looksrare v1`() = runBlocking<Unit> {
        val dto = randomEthLooksRareOrderDto().copy(taker = randomAddress())
        val converted = ethOrderConverter.convert(dto, BlockchainDto.ETHEREUM)
        ...
        assertThat(converted.takePriceUsd).isNull()
        val data = converted.data as EthLooksRareOrderDataV1Dto
    ...
    @Test
    fun `eth order looksrare v2`() = runBlocking<Unit> {
        val dto = randomEthLooksRareOrderV2Dto()
        val converted = ethOrderConverter.convert(dto, BlockchainDto.ETHEREUM)
        ...
        assertThat(converted.takePriceUsd).isNull()
        val data = converted.data as EthLooksRareOrderDataV2Dto

        assertThat(data.orderNonce).isEqualTo(dto.data.orderNonce)
        assertThat(data.additionalParameters).isEqualTo(dto.data.additionalParameters.prefixed())
        assertThat(data.globalNonce).isEqualTo(dto.data.globalNonce)
        assertThat(data.strategyId).isEqualTo(dto.data.strategyId)
        assertThat(data.quoteType.name).isEqualTo(dto.data.quoteType.name)
        assertThat(data.subsetNonce).isEqualTo(dto.data.subsetNonce)
        assertThat(data.merkleRoot).isEqualTo(dto.data.merkleRoot!!.prefixed())
        assertThat(data.merkleProof!![0].value).isEqualTo(dto.data.merkleProof!![0].value.prefixed())
        assertThat(data.merkleProof!![0].position).isEqualTo(dto.data.merkleProof!![0].position)
    }
